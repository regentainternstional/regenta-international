...
export default function Payment() {
  ...
  // ── Effect: read URL params or fall back to server autofill ──
  useEffect(() => {
    ...
    if (urlName || urlPhone || urlEmail || urlAmount) {
      // auto=1 + all fields: skip state entirely, fire payment immediately
    ...
    return (
      <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
        <div className="bg-white p-8 rounded-lg shadow-lg w-full max-w-md text-center">
          ...
          <p className="text-gray-700 font-medium text-lg">Redirecting to payment…</p>
